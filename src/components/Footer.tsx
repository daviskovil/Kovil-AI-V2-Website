        ...
        <div className="grid grid-cols-2 md:grid-cols-[1.4fr_1.3fr_1.2fr_1fr_1fr] gap-8 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted/60">
              ...
              <li>
                <Link href="/shopify" className="hover:text-accent transition-colors flex items-center gap-1.5">
                  Shopify AI Solutions
                  <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded-full" style={{ background: "#95BF4720", color: "#95BF47" }}>New</span>
                </Link>
              </li>
              <li>
                <Link href="/platforms" className="hover:text-accent transition-colors flex items-center gap-1.5">
                  Platform Integrations
                  <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded-full" style={{ background: "#F59E0B20", color: "#F59E0B" }}>New</span>
                </Link>
              </li>
