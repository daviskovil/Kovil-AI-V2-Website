...
export const metadata: Metadata = {
  title: 'Hire AutoGen Developers — Conversational Multi-Agent AI, Matched in 48 Hours',
...
// definition to lift for "what is AutoGen" / "what is an AutoGen developer"
// queries, independent of the FAQ prose.
const definedTermSchema = {
  '@context': 'https://schema.org',
  '@type': 'DefinedTerm',
  name: 'AutoGen Developer',
  description: "AutoGen is Microsoft's open-source framework for building conversational multi-agent AI systems, where multiple agents message each other, critique each other's outputs, and execute code to iteratively solve problems. An AutoGen developer designs these agent conversation systems — defining agent roles, configuring code execution environments with sandboxing for safety, orchestrating GroupChats, and deploying production-grade AutoGen pipelines.",
...
const webPageSchema = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  name: 'Hire AutoGen Developers — Conversational Multi-Agent AI, Matched in 48 Hours',
  description: 'Hire vetted AutoGen developers embedded in your team in 48 hours. Conversational multi-agent systems, code-executing agents, GroupChat orchestration, production deployment. 2-week risk-free trial.',
  url: 'https://kovil.ai/hire/autogen-developers',
