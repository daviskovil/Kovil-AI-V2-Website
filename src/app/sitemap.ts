...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/engage/computer-vision-engineers`,       lastModified: now,          changeFrequency: 'monthly', priority: 0.9 },
    { url: `${BASE_URL}/engage/machine-learning-engineers`,      lastModified: now,          changeFrequency: 'monthly', priority: 0.9 },
