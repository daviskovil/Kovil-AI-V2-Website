...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/hire/llamaindex-engineers`,              lastModified: now,          changeFrequency: 'monthly', priority: 0.9 },
    ...
    { url: `${BASE_URL}/shopify/solutions/beauty-cosmetics-ai-agents`,     lastModified: now,  changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/shopify/solutions/fashion-apparel-sizing-agents`,    lastModified: now,  changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/shopify/solutions/subscription-d2c-retention-agents`,lastModified: now,  changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/shopify/solutions/ai-product-recommendations`,     lastModified: now,  changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/shopify/solutions/autonomous-customer-service`,    lastModified: now,  changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/shopify/workflows/n8n-shopify-agentic-sync`,       lastModified: now,  changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/shopify/workflows/competitor-price-repricer`,      lastModified: now,  changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/shopify/workflows/spec-sheet-catalog-enricher`,    lastModified: now,  changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/shopify/workflows/returns-fraud-assessment`,       lastModified: now,  changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/shopify/workflows/whatsapp-agentic-marketing`,     lastModified: now,  changeFrequency: 'monthly', priority: 0.8 },
    ...
    // ── Agentforce service hub + service pages ────────────────────────────────
    { url: `${BASE_URL}/agentforce/services`,                                lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${BASE_URL}/agentforce/industries/legal-professional-services`,  lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/agentforce/industries/real-estate`,                  lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/agentforce/industries/energy-utilities`,             lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/agentforce/industries/logistics-supply-chain`,       lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/agentforce/industries/education`,                    lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/agentforce/industries/automotive`,                   lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/agentforce/industries/government-public-sector`,     lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
