    ...
    (
      <div style={{ background: 'linear-gradient(135deg, #06050F 0%, #0A080E 100%)', width: 1200, height: 630, display: 'flex', position: 'relative', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '60px 70px', flex: 1 }}>
          ...
          <div style={{ color: '#FF4F00', fontSize: 16, fontWeight: 600, letterSpacing: 4, marginBottom: 14, display: 'flex' }}>AI FOR ECOMMERCE</div>
          <div style={{ display: 'flex', flexDirection: 'column', marginBottom: 16 }}>
            <span style={{ color: 'white', fontSize: 60, fontWeight: 700, lineHeight: 1.1 }}>Support. Search.</span>
            <span style={{ color: '#FF4F00', fontSize: 60, fontWeight: 700, lineHeight: 1.1 }}>Revenue.</span>
          </div>
          <div style={{ color: '#5A4A80', fontSize: 20, marginBottom: 36, display: 'flex' }}>Chatbot · Recommendations · Forecasting</div>
          <div style={{ display: 'flex', gap: 20 }}>
            <div style={{ display: 'flex', flexDirection: 'column', background: '#0C0818', borderRadius: 12, padding: '16px 28px', border: '1px solid #1A1030' }}>
              <span style={{ color: '#FF4F00', fontSize: 42, fontWeight: 700, display: 'flex' }}>70%</span>
              <span style={{ color: '#5A4A80', fontSize: 14, display: 'flex', marginTop: 4 }}>Tickets Deflected</span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', background: '#0C0818', borderRadius: 12, padding: '16px 28px', border: '1px solid #1A1030' }}>
              <span style={{ color: 'white', fontSize: 42, fontWeight: 700, display: 'flex' }}>24/7</span>
              <span style={{ color: '#5A4A80', fontSize: 14, display: 'flex', marginTop: 4 }}>AI Support Coverage</span>
            </div>
          </div>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 320, background: '#0C0818', borderLeft: '1px solid #1A1030', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ color: '#2A1850', fontSize: 14, display: 'flex' }}>kovil.ai/ai-for-ecommerce</div>
        </div>
