...
import {
  ...
  Maximize2, Compass, ShieldCheck, Database, ShoppingBag
} from "lucide-react"
...
const features = [
  { icon: Maximize2, title: "Size & Fit Estimators", desc: "AI agents query users about height, weight, and brand fits to recommend sizing variants dynamically, lowering returns rates." },
  { icon: Compass, title: "Visual Outfit Orchestrator", desc: "Build styling agents that recommend matches based on the current variant (e.g. suggesting matching shoes and jackets for a dress)." },
  { icon: ShoppingBag, title: "Multi-Variant Bundle Checkout", desc: "Allow users to add coordinated outfits to draft checkout queues with a single chat confirmation command." },
  { icon: ShieldCheck, title: "Unified Catalog Syncer", desc: "Vetted models read stock levels across colors and variants, ensuring size options recommended are always in stock." }
]

const faqs = [
  { q: "How accurate is the sizing recommendation?", a: "The sizing recommendations leverage comparative database tables and custom questionnaire metrics to match user dimensions with specific variant measurements, ensuring a high-confidence fit." },
  { q: "Does this require modifications to my themes?", a: "No, we embed conversational advisor blocks using standard widgets or headless storefront API calls, keeping your theme completely clean." }
]
      ...
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-20">
        ...
        <div className="max-w-3xl space-y-6">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
            Deploy fashion styling and fit advisors. Let models size customer profiles accurately, construct visual matching recommendations, and process bundle variant carts.
          </p>
      ...
      <section className="py-20 px-6 border-t border-border bg-muted/10">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-2 max-w-xl mx-auto">
            <h2 className="text-3xl font-bold tracking-tight">Fashion & Sizing Capabilities</h2>
            <p className="text-muted-foreground text-sm">
              Deliver sizing fit advice and outfit visual bundles that lower returns.
            </p>
          </div>
      ...
      <section className="py-20 px-6 border-t border-border bg-muted/10">
        <div className="max-w-3xl mx-auto space-y-12">
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground text-sm">
              Answers regarding styling workflows and catalog sizes.
            </p>
          </div>
      ...
      <section className="py-20 px-6 border-t border-border bg-background">
        <div className="max-w-4xl mx-auto rounded-3xl bg-foreground text-background p-10 md:p-14 text-center relative overflow-hidden">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">
            Build Your Visual Fashion Stylist
          </h2>
          <p className="text-background/60 max-w-xl mx-auto mb-8 leading-relaxed text-sm">
            Launch customized size recommendations and fashion styling agents with a 2-week risk-free trial.
          </p>
