...
import { ArrowLeft, ArrowRight, Clock, Calendar, Users, Lightbulb, DollarSign, AlertTriangle, CheckCircle, HelpCircle, TrendingUp } from "lucide-react"
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-sm font-semibold" style={{ color: SF_BLUE }}>Pricing at a glance</span>
      </div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        >
          ...
          <h3 className="font-display text-xl font-semibold mb-3 mt-8">What counts as a conversation?</h3>
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
          ...
          <h3 className="font-display text-xl font-semibold mb-3 mt-8">Data Cloud — required for most serious deployments</h3>
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
          ...
          <h3 className="font-display text-xl font-semibold mb-3 mt-8">Einstein licences</h3>
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
          ...
          <h3 className="font-display text-xl font-semibold mb-3 mt-8">MuleSoft for external integrations</h3>
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
          ...
          <h3 className="font-display text-xl font-semibold mb-3 mt-8">Your base Salesforce licences</h3>
          <p className="text-base text-muted-foreground leading-relaxed mb-6">
          ...
          <h3 className="font-display text-xl font-semibold mb-3 mt-8">Fixed-price pilot (2–3 weeks): $15,000–$35,000</h3>
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
          ...
          <h3 className="font-display text-xl font-semibold mb-3 mt-8">Full multi-cloud deployment (6–12 weeks): $60,000–$180,000</h3>
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
          ...
          <h3 className="font-display text-xl font-semibold mb-3 mt-8">Ongoing managed services: $5,000–$15,000/month</h3>
          <p className="text-base text-muted-foreground leading-relaxed mb-6">
          ...
          >
            <div className="px-5 py-3 text-xs font-mono font-semibold uppercase tracking-wider" style={{ backgroundColor: `${SF_BLUE}15`, color: SF_BLUE }}>
            ...
            <div className="divide-y divide-border">
              ...
              <div className="flex items-center justify-between px-5 py-3 font-bold" style={{ backgroundColor: `${SF_BLUE}05` }}>
