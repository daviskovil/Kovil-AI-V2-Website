...
const faqs = [
  ...
  { q: "How much does it cost to hire a Claude Code engineer?", a: "Rates depend on seniority and engagement. A senior engineer full-time in the US typically costs $170,000–$250,000 in base salary plus recruiting time and equity. Freelance rates vary widely and quality is inconsistent. Kovil AI places a vetted, Engagement-Manager-audited Claude Code engineer on a fixed monthly or milestone basis — usually a fraction of a full-time hire's fully-loaded cost, with no recruiting delay, a 2-week risk-free trial, and no lock-in. Because agentic coding compresses delivery time, the effective cost per shipped outcome is often dramatically lower." },
