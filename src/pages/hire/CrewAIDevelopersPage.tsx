  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Definition — explicit, citable answer for "what is a
          CrewAI developer" queries, independent of the FAQ prose */}
      <section id="definition" className="border-t border-border bg-muted/10">
        <div className="max-w-7xl mx-auto px-6 py-14">
          <div className="max-w-3xl">
            <h2 className="font-display font-bold text-2xl lg:text-3xl mb-4">What Is a CrewAI Developer?</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              A <strong className="text-foreground">CrewAI developer</strong> builds on CrewAI, an open-source multi-agent framework built on top of LangChain that lets teams of AI agents collaborate on complex tasks, each with a defined role, goal, and backstory. They design and build these agent systems — defining roles, orchestrating task flows, integrating tools, and deploying crews that run reliably in production for use cases like research pipelines, content workflows, and data analysis.
            </p>
          </div>
        </div>
      </section>
