...
export default function LangGraphEngineersPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Definition — explicit, citable answer for "what is a
          LangGraph engineer" queries, independent of the FAQ prose */}
      <section id="definition" className="border-t border-border bg-muted/10">
        <div className="max-w-7xl mx-auto px-6 py-14">
          <div className="max-w-3xl">
            <h2 className="font-display font-bold text-2xl lg:text-3xl mb-4">What Is a LangGraph Engineer?</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              A <strong className="text-foreground">LangGraph engineer</strong> builds on LangGraph, a library built on LangChain for building stateful, multi-actor agent applications as directed graphs — enabling conditional branching, looping, parallel execution, and human-in-the-loop interrupts that a simple linear chain cannot express. They design and implement these graph-based agent systems, defining nodes, edges, state schemas, and persistence layers, for complex RAG pipelines, autonomous agents, and multi-agent orchestration.
            </p>
          </div>
        </div>
      </section>
