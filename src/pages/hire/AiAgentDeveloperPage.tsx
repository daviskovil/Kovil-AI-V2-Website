...
const faqs = [
  ...
  { q: "How much does it cost to hire an AI agent developer?", a: "Rates vary by seniority and engagement model. Kovil AI places vetted, Engagement-Manager-audited agent engineers on a fixed monthly or milestone basis. By utilizing our global talent pool and agentic workflows, you get elite, production-ready engineers at a fraction of the cost of full-time recruiting, with zero hiring delay and a 2-week risk-free trial." },
